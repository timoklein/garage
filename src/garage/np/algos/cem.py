...
class CEM(RLAlgorithm):
    ...
    def _sample_params(self, epoch):
        ...
        sample_std = np.sqrt(np.square(self._cur_std) + np.square(self._extra_std) * extra_var_mult)
    ...
    def train(self, trainer):
        ...
        assert self._n_best >= 1, "n_samples is too low. Make sure that n_samples * best_frac >= 1"
