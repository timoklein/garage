...
class SAC(RLAlgorithm):
    ...
    def __init__(
        ...
        *,  # Everything after this is numbers.
        ...
        temporal_regularization_factor=0.0,
        spatial_regularization_factor=0.0,
        spatial_regularization_eps=1.0
    ):
        self._qf1 = qf1
        self._qf2 = qf2
                ...
                for path in trainer.step_episode:
                    self.replay_buffer.add_path(
                        dict(
                            ...
                            terminal=np.array([step_type == StepType.TERMINAL for step_type in path["step_types"]]).reshape(
                                -1, 1
                            ),
                        )
                    )
    ...
    def optimize_policy(self, samples_data):
        ...
        policy_loss += self._caps_regularization_objective(action_dists, samples_data)
