    ...
    def __init__(
        ...
        *,
        ...
        if not isinstance(env_spec.action_space, akro.Discrete):
            raise ValueError("CategoricalMLPPolicy only works " "with akro.Discrete action space.")
        if isinstance(env_spec.observation_space, akro.Dict):
            raise ValueError("CNN policies do not support " "with akro.Dict observation spaces.")
