...
def maml_trpo_metaworld_ml1_push(ctxt, seed, epochs, rollouts_per_task, meta_batch_size):
    ...
    test_sampler = SetTaskSampler(MetaWorldSetTaskEnv, env=MetaWorldSetTaskEnv(ml1, "test"))
    ...
    meta_evaluator = MetaEvaluator(test_task_sampler=test_sampler, n_test_tasks=1, n_exploration_eps=rollouts_per_task)
    ...
    trainer.train(n_epochs=epochs, batch_size=rollouts_per_task * env.spec.max_episode_length)
