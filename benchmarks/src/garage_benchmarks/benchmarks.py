...
register_benchmark(
    {
        ...
        "tasks": [
            {"desc": _game, "env_id": _game + _ATARI_SUFFIX, "trials": 2, "num_timesteps": int(50e6)} for _game in _atari7
        ],
    }
)
...
register_benchmark(
    {
        ...
        "tasks": [
            {"desc": _game, "env_id": _game + _ATARI_SUFFIX, "trials": 6, "num_timesteps": int(10e6)} for _game in _atari7
        ],
    }
)
...
register_benchmark(
    {
        ...
        "tasks": [
            {"desc": _game, "env_id": _game + _ATARI_SUFFIX, "trials": 2, "num_timesteps": int(10e6)} for _game in _atariexpl7
        ],
    }
)
...
# Bullet
_bulletsmall = ["InvertedDoublePendulum", "InvertedPendulum", "HalfCheetah", "Reacher", "Walker2D", "Hopper", "Ant"]
...
register_benchmark(
    {
        ...
        "tasks": [
            {"desc": _game, "env_id": _game + _ATARI_SUFFIX, "trials": 2, "num_timesteps": int(10e6)} for _game in _atari50
        ],
    }
)
