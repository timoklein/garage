...
@pytest.mark.parametrize("input_dim, output_dim, hidden_sizes, learn_std", plain_settings)
def test_std_share_network_output_values(input_dim, output_dim, hidden_sizes, learn_std):
...
@pytest.mark.parametrize("input_dim, output_dim, hidden_sizes, learn_std", plain_settings)
def test_std_share_network_output_values_with_batch(input_dim, output_dim, hidden_sizes, learn_std):
    module = GaussianMLPTwoHeadedModule(
        input_dim=input_dim,
        output_dim=output_dim,
        hidden_sizes=hidden_sizes,
    ...
    exp_mean = torch.full((batch_size, output_dim), input_dim * (torch.Tensor(hidden_sizes).prod().item()), dtype=torch.float)
    exp_variance = (input_dim * torch.Tensor(hidden_sizes).prod()).exp().pow(2).item()

    assert dist.mean.equal(exp_mean)
    assert dist.variance.equal(torch.full((batch_size, output_dim), exp_variance, dtype=torch.float))
    assert dist.rsample().shape == (batch_size, output_dim)


@pytest.mark.parametrize("input_dim, output_dim, hidden_sizes, learn_std", plain_settings)
def test_std_network_output_values(input_dim, output_dim, hidden_sizes, learn_std):
    init_std = 2.0
...
@pytest.mark.parametrize("input_dim, output_dim, hidden_sizes, learn_std", plain_settings)
def test_std_network_output_values_with_batch(input_dim, output_dim, hidden_sizes, learn_std):
    init_std = 2.0
...
@pytest.mark.parametrize("input_dim, output_dim, hidden_sizes, std_hidden_sizes", different_std_settings)
...
@pytest.mark.parametrize("input_dim, output_dim, hidden_sizes, learn_std", plain_settings)
def test_softplus_std_network_output_values(input_dim, output_dim, hidden_sizes, learn_std):
    init_std = 2.0
...
@pytest.mark.parametrize("input_dim, output_dim, hidden_sizes, learn_std", plain_settings)
def test_exp_min_std(input_dim, output_dim, hidden_sizes, learn_std):
    min_value = 10.0
...
@pytest.mark.parametrize("input_dim, output_dim, hidden_sizes, learn_std", plain_settings)
def test_exp_max_std(input_dim, output_dim, hidden_sizes, learn_std):
    max_value = 1.0
...
@pytest.mark.parametrize("input_dim, output_dim, hidden_sizes, learn_std", plain_settings)
def test_softplus_min_std(input_dim, output_dim, hidden_sizes, learn_std):
    min_value = 2.0
...
@pytest.mark.parametrize("input_dim, output_dim, hidden_sizes, learn_std", plain_settings)
def test_softplus_max_std(input_dim, output_dim, hidden_sizes, learn_std):
    max_value = 1.0
    ...
    assert torch.equal(dist.variance, torch.full((output_dim,), exp_variance[0], dtype=torch.float))
