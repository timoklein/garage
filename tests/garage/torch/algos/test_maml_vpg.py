...
class TestMAMLVPG:
    ...
    def setup_method(self):
        ...
        self.env = normalize(GymEnv(HalfCheetahDirEnv(), max_episode_length=max_episode_length), expected_action_scale=10.0)
        ...
        self.value_function = GaussianMLPValueFunction(env_spec=self.env.spec, hidden_sizes=(32, 32))
    ...
    def test_ppo_pendulum(self):
        ...
        last_avg_ret = trainer.train(n_epochs=10, batch_size=episodes_per_task * max_episode_length)
