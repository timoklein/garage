...
class TestMAML:
    ...
    def setup_method(self):
        ...
        task_sampler = SetTaskSampler(lambda: normalize(GymEnv(HalfCheetahDirEnv()), expected_action_scale=10.0))
    ...
    def test_adapt_policy(self):
        ...
        for v1, v2 in zip(adapt_policy.parameters(), self.policy.parameters()):
            ...
            pytest.fail("Parameters of adapted policy should not be " "identical to the old policy.")
